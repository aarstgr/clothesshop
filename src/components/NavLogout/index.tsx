...
const NavLogout = () => {
  ...
  return (
    ...
    <AppBar position="static" sx={{ background:'#DDE9FF',paddingRight:"20px",boxShadow: 1}} >
      ...
      <img src='/logo.png' className='w-7 mr-3'/>
        ...
        <Menu anchorEl={anchorEl}  keepMounted open={Boolean(anchorEl)} onClose={handleMenuClose}>
          <MenuItem onClick={handleMenuClose}><Link to="/auth/login">Login</Link></MenuItem>
          <MenuItem onClick={handleMenuClose}><Link to="/auth/register">Register</Link></MenuItem>
        </Menu>
      </Toolbar>
    </AppBar>
    </Box>
...
export default React.memo(NavLogout);
